...
select count(gender) as 여직원 from employees where gender = 'f';
select count(gender) as 남직원 from employees where gender = 'm';

-- 문제 4
-- 현재 근무하고 있는 직원 수는 몇 명입니까? (salaries 테이블을 사용합니다.)
select count(*) as '현재 근무중인 직원 수' from salaries where to_date = '9999-01-01';
...
select count(*) as '현재 부서 매니저 수' from dept_manager where to_date = '9999-01-01'; 
...
select count(*) as '120,000 이상 받는 사원 수' from salaries where salary >= 120000 and to_date = '9999-01-01';
...
select count(title) as 'Engineer 사원 수' from titles where title = 'Engineer' and to_date = '9999-01-01';
